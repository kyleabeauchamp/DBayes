...
def simulate_density(molecule, temperature, pressure, out_dir, stderr_tolerance=0.0001, n_steps=400000, nonbondedCutoff=1.1 * u.nanometer, output_frequency=250, print_frequency=250):
