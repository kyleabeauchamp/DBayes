...
Q = data.pivot_table(index=keys, columns=["temperature"], values=["energy", "density", "dielectric"])
...
figure()
sns.interactplot(keys[0], keys[1], "energy", mydata, cmap="coolwarm", filled=True, levels=25);
